%%  N-tuple + Quadratic Discriminant Analysis Implementation
%   By - Sammit Jain | Visiting Research Scholar, CUNY
%   Dataset - Splice-junction gene sequences

function [tuples,accuracy] = qda_n_tuple_splice(M,N)
...
qda_scores = zeros(size(crossval,1),num_classes);
